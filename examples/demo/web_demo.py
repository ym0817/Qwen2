...
# DEFAULT_CKPT_PATH = 'E:\\Qwen2\\qwen\\Qwen2-7B-Instruct'
DEFAULT_CKPT_PATH = "E:\\Qwen2\\qwen\\Qwen2-0___5B-Instruct"
...
def _get_args():
    ...
    parser.add_argument("--server-port", type=int, default=6060,
